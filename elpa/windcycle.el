...
(global-set-key (kbd "ESC <up>") 'windmove-up-cycle)
(global-set-key (kbd "ESC <down>") 'windmove-down-cycle)
(global-set-key (kbd "ESC <right>") 'windmove-right-cycle)
(global-set-key (kbd "ESC <left>") 'windmove-left-cycle)
